...
This is true for all the mentioned goals expect for what concerns G9, that is the blocking of third party
...
and the average speeds satisfies this requirement.
